...
server.on('connection', (cws) => {
    ...
    connection.addMessageListener(Types_1.MessageType.PRIVATE_UUID, (client_info) => {
        ...
        client.addMessageListener(Types_1.MessageType.TEST, (data) => console.log("Recieved test message: " + data));
        client.send(Types_1.MessageType.PUBLIC_UUID, client.getSessionUUID());
    });
    connection.send(Types_1.MessageType.PRIVATE_UUID_REQ, "");
});
